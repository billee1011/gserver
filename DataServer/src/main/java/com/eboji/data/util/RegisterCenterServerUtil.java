package com.eboji.data.util;

import java.util.HashSet;
import java.util.Set;

import com.eboji.data.bootstrap.Daemon;
import com.eboji.data.server.transfer.tcp.ServerClientTransfer;
import com.eboji.data.server.transfer.tcp.connection.ServerClientConnection;
...
public class RegisterCenterServerUtil {
	public static void registerService() {
		...
		regMsg.setServerId(Constant.SRV_DATA);
